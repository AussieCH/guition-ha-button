...
> **Hinweis:** Dieser Abschnitt beschreibt das **Referenz-Repo**
> [esphome-guition-jc3636k718c-va](https://github.com/MichalZaniewicz/esphome-guition-jc3636k718c-va)
> (Voice-Assistant, modular mit `base/core.yaml` + Screen-Packages), **nicht** dieses
> Repo. Hier ist alles in der einzelnen Datei [`guition-button.yaml`](../guition-button.yaml).
> Pinout, Komponenten-Wahl und die Gotchas oben gelten aber 1:1.
